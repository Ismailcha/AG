            ...
            <div class="col-md-6">
                <div class="image-slider">
                    @foreach ($item->itemImages as $key => $image)
                        <input type="radio" id="slide-{{ $key + 1 }}" name="slider" {{ $key === 0 ? 'checked' : '' }}>
                        <div class="slide">
...
.image-slider {
    ...
    width: 400px; /* Set the fixed width for the slider container */
...
.slide img {
            width: 100%; /* Ensure all images fill the slider width */
            height: 100px; /* Set a fixed height for the images (adjust as needed) */
