...
<div class="card card-flush h-xl-100">
	...
	<div class="card-header pt-5">
		...
		<h3 class="card-title align-items-start flex-column">
			<span class="card-label fw-bold text-gray-800">Achats & Ventes</span>
			<span class="text-gray-400 mt-1 fw-semibold fs-6">Listes des Achats & Ventes</span>
		</h3>
		<!--end::Title-->
		<!--begin::Toolbar-->
	...
	<div class="card-body pt-6">
		...
		<input type="text"  placeholder="entrez l'ID de l'operation" class="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column overflow-hidden w-300px h-20px pt-5 pb-2 d-flex align-items-center p-0 pb-3 min-w-150px text-start card-toolbar btn btn-icon btn-color-gray-400 btn-active-color-primary justify-content-end">
		<span class="menu-icon">{!! getIcon('magnifier', 'fs-2') !!}</span>
		<!--end::Nav-->
		<!--begin::Tab Content-->
		...
		<div class="text-center">
				<a href='#' class="btn btn-sm btn-dark fw-bold" data-bs-toggle="modal" data-bs-target="#kt_modal_upgrade_plan">Ajout d’achat</a>
				<a href='#' class="btn btn-sm btn-dark fw-bold" data-bs-toggle="modal" data-bs-target="#kt_modal_upgrade_plan">Ajout de vente</a>
